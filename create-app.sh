...
oc new-app https://github.com/rayenchtioui/microservices-base  --as-deployment-config=true --build-env=DATABASE_URL="postgresql://$(get_env database-user):$(get_env database-password)@postgresql:5432/$(get_env database-name)?schema=public"
